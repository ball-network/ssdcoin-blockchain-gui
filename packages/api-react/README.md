# ssdcoin-blockchain-gui/api-react
...
This library provides react hooks on the top of @ssdcoin-network/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under the hood.
...
- Automatically refresh queries when data changed (using events from SSDCoin Blockchain).
...
import { useGetPublicKeysQuery } from '@ssdcoin-network/api-react';
import { Loading } from '@ssdcoin-network/core';
...
import { store, api } from '@ssdcoin-network/api-react';
