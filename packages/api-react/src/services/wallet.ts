...
import { CAT, DID, Farmer, NFT, Pool, WalletService, WalletType, toBech32m, VC, Staking } from '@ssdcoin-network/api';
import type { NFTInfo, Transaction, Wallet, WalletBalance } from '@ssdcoin-network/api';
