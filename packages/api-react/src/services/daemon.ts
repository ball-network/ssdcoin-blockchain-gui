import { Daemon, optionsForPlotter, defaultsForPlotter, PlotterName } from '@ssdcoin-network/api';
import type { Plotter, PlotterMap, PlotterApi } from '@ssdcoin-network/api';
