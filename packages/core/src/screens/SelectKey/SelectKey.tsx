import type { KeyData } from '@ssdcoin-network/api';
import {
  usePrefs,
...
import { SSDCoinBlack, Coins } from '@ssdcoin-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with SSDCoin.</Trans>
              </Typography>
              <Button
