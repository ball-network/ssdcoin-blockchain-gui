...
import ssdcoinToMojo from '../../utils/ssdcoinToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isSSDCoinCurrency = ['SSD', 'TSSD'].includes(currencyCode);
  const mojo = isSSDCoinCurrency ? ssdcoinToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isSSDCoinCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
