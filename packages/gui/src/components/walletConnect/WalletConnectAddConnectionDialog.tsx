import { useGetKeysQuery, useGetLoggedInFingerprintQuery, usePrefs } from '@ssdcoin-network/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToSSDCoin.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const mainnet = useCurrencyCode() === 'SSD';
