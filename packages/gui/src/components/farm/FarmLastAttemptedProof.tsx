import { useGetNewFarmingInfoQuery } from '@ssdcoin-network/api-react';
import { Link, Table, Card } from '@ssdcoin-network/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/ball-network/ssdcoin-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
