import { SyncingStatus } from '@ssdcoin-network/api';
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@ssdcoin-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@ssdcoin-network/core';
import { useWalletState } from '@ssdcoin-network/wallets';
