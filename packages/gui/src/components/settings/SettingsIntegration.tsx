import { Flex, MenuItem, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@ssdcoin-network/core';
                ...
                <Grid item container style={{ width: '400px' }} gap={2}>
                  <SettingsText>
                    <Trans>
                      ...
                      command issued by the Dapp will require confirmation in the SSDCoin wallet.
                    </Trans>
                  </SettingsText>
                </Grid>
              </>
