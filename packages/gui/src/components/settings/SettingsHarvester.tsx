import { ServiceName, HarvesterConfig } from '@ssdcoin-network/api';
import {
...
import { ButtonLoading, Flex, SettingsHR, SettingsSection, SettingsTitle, SettingsText } from '@ssdcoin-network/core';
