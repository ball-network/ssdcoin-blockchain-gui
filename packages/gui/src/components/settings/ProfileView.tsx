...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@ssdcoin-network/api-react';
import { Color, CopyToClipboard, Flex, Suspender, Tooltip, truncateValue } from '@ssdcoin-network/core';
