import { useGetAutoClaimQuery, useSetAutoClaimMutation } from '@ssdcoin-network/api-react';
import { Flex, SettingsText, Form, ButtonLoading, Fee, ssdcoinToMojo, mojoToSSDCoin } from '@ssdcoin-network/core';
import { ConnectCheckmark } from '@ssdcoin-network/icons';
...
export default function SettingsCustodyAutoClaim(props) {
  ...
  const autoClaimFee = autoClaimData?.txFee ? mojoToSSDCoin(autoClaimData.txFee).toNumber() : 0;
