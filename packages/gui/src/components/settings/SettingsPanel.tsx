...
import { useGetKeyringStatusQuery } from '@ssdcoin-network/api-react';
import {
  AlertDialog,
  Button,
  Color,
          ...
          <Flex gap={1} alignItems="center">
            ...
            <TooltipIcon>
              <Trans>
                ...
                number is generally higher if you have a lot of transactions or canceled offers for SSD, CATs, or NFTs.
