...
import { useGetWalletsQuery } from '@ssdcoin-network/api-react';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@ssdcoin-network/core';
import { Tokens } from '@ssdcoin-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>SSDCoin Asset Tokens (CATs) are tokens built on top of SSD</Trans>}
