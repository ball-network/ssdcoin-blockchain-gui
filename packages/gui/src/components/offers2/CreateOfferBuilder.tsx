...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@ssdcoin-network/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@ssdcoin-network/core';
