import { defaultPlotter, toBech32m, fromBech32m, WalletCreatePool } from '@ssdcoin-network/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@ssdcoin-network/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@ssdcoin-network/core';
