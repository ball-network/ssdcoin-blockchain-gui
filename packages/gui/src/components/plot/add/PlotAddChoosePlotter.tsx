import { defaultPlotter, PlotterName } from '@ssdcoin-network/api';
import type { Plotter, PlotterMap } from '@ssdcoin-network/api';
import { useGetPlottersQuery } from '@ssdcoin-network/api-react';
import { CardStep, Select, StateColor } from '@ssdcoin-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.SSDCOINPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default SSDCoin Proof of Space plotter. If unsure, use the default SSDCoin Proof of Space plotter.
        </Trans>
      </Typography>
