import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@ssdcoin-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/ball-network/ssdcoin-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
