import { type Plot } from '@ssdcoin-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@ssdcoin-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@ssdcoin-network/core';
