import { useRefreshPlotsMutation } from '@ssdcoin-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@ssdcoin-network/core';
import { Plots } from '@ssdcoin-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn SSDCoin. &nbsp;
