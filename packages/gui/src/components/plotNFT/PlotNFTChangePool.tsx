import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@ssdcoin-network/api-react';
import { Flex, State, Loading, StateTypography } from '@ssdcoin-network/core';
