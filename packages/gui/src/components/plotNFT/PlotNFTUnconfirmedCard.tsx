import type { UnconfirmedPlotNFT } from '@ssdcoin-network/api';
import { useGetTransactionQuery } from '@ssdcoin-network/api-react';
import { Flex, Link, Loading } from '@ssdcoin-network/core';
