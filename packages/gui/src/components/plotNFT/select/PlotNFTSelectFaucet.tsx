import { Button, Flex, CardStep, useCurrencyCode } from '@ssdcoin-network/core';
...
export default function PlotNFTSelectFaucet(props: Props) {
  ...
  const handleClick = React.useCallback(() => {
    if (currencyCode === 'TSSD') {
      openExternal('https://testnet10-faucet.ssdcoin.top/');
    } else {
      openExternal('https://faucet.ssdcoin.top/');
    }
