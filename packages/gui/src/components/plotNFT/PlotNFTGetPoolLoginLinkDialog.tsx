import type { PlotNFT, PlotNFTExternal } from '@ssdcoin-network/api';
import { useGetPoolLoginLinkQuery } from '@ssdcoin-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@ssdcoin-network/core';
