import type { AddressContact } from '@ssdcoin-network/core';
import { AddressBookContext, CardListItem, Color, Flex, LayoutDashboardSub, Tooltip } from '@ssdcoin-network/core';
import { MyContacts as MyContactsIcon } from '@ssdcoin-network/icons';
