import { toBech32m, fromBech32m } from '@ssdcoin-network/api';
import { useGetCurrentAddressQuery, useSendNotificationMutation } from '@ssdcoin-network/api-react';
import {
  AlertDialog,
  Amount,
  ButtonLoading,
...
export default function NotificationSendDialog(props: NotificationSendDialogProps) {
  ...
  async function handleSubmit(values: NotificationSendDialogFormData) {
    ...
    const amountMojos = ssdcoinToMojo(amount);
    const feeMojos = ssdcoinToMojo(fee);
