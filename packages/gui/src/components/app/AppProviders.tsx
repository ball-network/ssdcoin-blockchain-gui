...
import WalletConnectProvider, { WalletConnectSSDCoinProjectId } from '../walletConnect/WalletConnectProvider';
                        ...
                        <AddressBookProvider>
                          <OffersProvider>
                            <NotificationsProvider>
                              <WalletConnectProvider projectId={WalletConnectSSDCoinProjectId}>
