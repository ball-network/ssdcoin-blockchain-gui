import { Button, Flex } from '@ssdcoin-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The SSDCoin application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                SSDCoin services version: {backV}
                <br />
                SSDCoin application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the SSDCoin application and stop all SSDCoin services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
