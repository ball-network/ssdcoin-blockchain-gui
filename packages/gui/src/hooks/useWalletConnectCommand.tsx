import api, { store, useGetLoggedInFingerprintQuery } from '@ssdcoin-network/api-react';
import { useOpenDialog, useAuth } from '@ssdcoin-network/core';
...
const log = debug('ssdcoin-gui:walletConnectCommand');
