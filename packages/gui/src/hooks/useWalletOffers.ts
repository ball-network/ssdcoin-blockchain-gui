import { OfferCoinOfInterest, OfferSummaryRecord } from '@ssdcoin-network/api';
import { useGetOffersCountQuery, useGetAllOffersQuery } from '@ssdcoin-network/api-react';
