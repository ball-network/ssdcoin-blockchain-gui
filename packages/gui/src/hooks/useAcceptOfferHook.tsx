import type { OfferSummaryRecord, Wallet } from '@ssdcoin-network/api';
import { useTakeOfferMutation } from '@ssdcoin-network/api-react';
import { AlertDialog, ssdcoinToMojo, useOpenDialog, useShowError } from '@ssdcoin-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? ssdcoinToMojo(fee) : new BigNumber(0);
