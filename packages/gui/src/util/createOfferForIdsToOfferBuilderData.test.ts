import * as ssdcoinCore from '@ssdcoin-network/core';
...
describe('createOfferForIdsToOfferBuilderData', () => {
  ...
  describe('when offering SSD for CAT', () => {
    it('should return a valid offer builder data object', () => {
      ...
      ssdcoinCore.mojoToSSDCoin.mockReturnValue(new BigNumber(111.555));
      ssdcoinCore.mojoToCAT.mockReturnValue(new BigNumber(600));
  ...
  describe('when offering a CAT for SSD', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      ssdcoinCore.mojoToSSDCoin.mockReturnValue(new BigNumber(2));
      ssdcoinCore.mojoToCAT.mockReturnValue(new BigNumber(1.234));
  ...
  describe('when offering SSD for an NFT', () => {
    it('should return a valid offer builder data object', () => {
      const calledLookupByWalletIdWithIds: string[] = [];
      const assetIdMapEntriesByWalletId: Record<string, AssetIdMapEntry> = {
        1: {
      ...
      ssdcoinCore.mojoToSSDCoin.mockReturnValue(new BigNumber(3));
  ...
  describe('when the offered asset is for an unknown wallet type', () => {
    it('should ignore the unknown wallet assets', () => {
      ...
      ssdcoinCore.mojoToSSDCoin.mockReturnValue(new BigNumber(0.5));
  ...
  describe('when lookupByWalletId throws', () => {
    ...
    it('should ignore the asset that caused the error', () => {
      ...
      ssdcoinCore.mojoToSSDCoin.mockReturnValue(new BigNumber(5));
      ssdcoinCore.mojoToCAT.mockReturnValue(new BigNumber(1000));
