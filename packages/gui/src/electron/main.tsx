...
import { NFTInfo } from '@ssdcoin-network/api';
...
import AppIcon from '../assets/img/ssdcoin64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import ssdcoinEnvironment from '../util/ssdcoinEnvironment';
...
// Set the userData directory to its location within SSDCOIN_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!ssdcoinEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      ssdcoinEnvironment.startSSDCoinDaemon();
    }
...
function getMenuTemplate() {
    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/ball-network/ssdcoin-blockchain/releases');
          },
        },
        {
        ...
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/ball-network/ssdcoin-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/ssdcoin');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/ssdcoin_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // SSDCoin Blockchain menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'SSDCoin' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About SSDCoin Blockchain' }),
          click: () => {
            openAbout();
          },
        },
