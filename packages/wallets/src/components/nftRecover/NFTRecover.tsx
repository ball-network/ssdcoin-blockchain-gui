...
import type { NFTRecoverInfo } from '@ssdcoin-network/api';
import {
  useLocalStorage,
...
export default function NFTRecover(props: NFTRecoverProps) {
  ...
  async function handleSubmit() {
    ...
    setContent(`${t1  }: ${  mojoToSSDCoin(response.amount)  } ${  currencyCode}, ${t2  }: ${t3
        ...
        <Grid spacing={2} alignItems="stretch" container>
          ...
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSSDCoinLocaleString(nftData.totalAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSSDCoinLocaleString(nftData.balanceAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToSSDCoinLocaleString(nftData.recordAmount, locale):"-"}
            />
          </Grid>
        </Grid>
        </Form>
