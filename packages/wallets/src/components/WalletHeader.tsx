...
import { Button, Flex, ConfirmDialog, useOpenDialog, DropdownActions, MenuItem } from '@ssdcoin-network/core';
...
type StandardWalletProps = {
  walletId: number;
  actions?: ReactNode;
  tab: 'summary' | 'send' | 'receive' | 'stakeFarm' | 'nftRecover';
  onTabChange: (tab: 'summary' | 'send' | 'receive' | 'stakeFarm' | 'nftRecover') => void;
  onStakeOld: () => void;
};
