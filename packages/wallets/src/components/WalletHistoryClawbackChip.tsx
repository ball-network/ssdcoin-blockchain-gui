import { TransactionType } from '@ssdcoin-network/api';
import type { Transaction } from '@ssdcoin-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@ssdcoin-network/api-react';
import { useTrans, Button } from '@ssdcoin-network/core';
