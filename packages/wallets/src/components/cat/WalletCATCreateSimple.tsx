import type { CATToken } from '@ssdcoin-network/api';
import { SyncingStatus } from '@ssdcoin-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@ssdcoin-network/api-react';
import { Back, Flex, Loading, useShowError } from '@ssdcoin-network/core';
