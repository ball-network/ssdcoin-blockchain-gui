import { english } from '@ssdcoin-network/api';
import { useAddPrivateKeyMutation } from '@ssdcoin-network/api-react';
import {
  AlertDialog,
  Autocomplete,
  Button,
      ...
      <Container maxWidth="lg">
        <Flex flexDirection="column" gap={3} alignItems="center">
          ...
          <Typography variant="subtitle1" align="center">
            <Trans>
              Enter the {mnemonicWordCount} word mnemonic that you have saved in order to restore your SSDCoin wallet.
            </Trans>
          </Typography>
