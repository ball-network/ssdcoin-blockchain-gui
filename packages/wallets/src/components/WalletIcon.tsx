import { WalletType, type Wallet } from '@ssdcoin-network/api';
import { useGetCatListQuery } from '@ssdcoin-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@ssdcoin-network/core';
import { CrCat } from '@ssdcoin-network/icons';
