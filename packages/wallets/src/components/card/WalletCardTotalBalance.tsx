import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@ssdcoin-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@ssdcoin-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for SSD, CATs, or
