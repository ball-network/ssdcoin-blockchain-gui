import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@ssdcoin-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@ssdcoin-network/core';
import { Reload } from '@ssdcoin-network/icons';
